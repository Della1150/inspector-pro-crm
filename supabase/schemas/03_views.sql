...
select
    ...
    co.email,
    co.website,
    co.facebook_url as "facebookUrl",
    co.instagram_url as "instagramUrl",
    co.google_business_url as "googleBusinessUrl",
    co.follow_up_date as "followUpDate",
    co.freebie_delivered as "freebieDelivered",
    co.referral_count as "referralCount",
    co.notes,
    co.office_visited_date as "officeVisitedDate",
    co.gift_freebie_left as "giftFreebieLeft",
    co.preferred_contact_method as "preferredContactMethod",
    co.brokerage_office_address as "brokerageOfficeAddress",
